...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  private List<Recipe> getRecipes() {
    ...
    eachUOMOptional.orElseThrow(() -> new NoSuchElementException("Expected UOM Not Found"));

    Optional<UnitOfMeasure> teaspoonUOMOptional = unitOfMeasureRepository.findByUnitName("Teaspoon");

    teaspoonUOMOptional.orElseThrow(() -> new NoSuchElementException("Expected UOM Not Found"));

    Optional<UnitOfMeasure> tableSpoonUOMOptional = unitOfMeasureRepository.findByUnitName("Tablespoon");

    tableSpoonUOMOptional.orElseThrow(() -> new NoSuchElementException("Expected UOM Not Found"));
    ...
    americanCategoryOptional.orElseThrow(() -> new NoSuchElementException("Expected Category Not Found"));

    Optional<Category> mexicanCategoryOptional = categoryRepository.findByCategoryName("Mexican");

    mexicanCategoryOptional.orElseThrow(() -> new NoSuchElementException("Expected Category Not Found"));
    ...
    guacRecipe.addIngredient(new Ingredient("freshly grated black pepper", new BigDecimal(2), eachUom));
    ...
    tacosRecipe.addIngredient(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), eachUom));
